...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.stylesSet = [
        { name: 'Note', element: 'div', attributes: { 'class': 'markdown-alert markdown-alert-note' } },
        { name: 'Warning', element: 'div', attributes: { 'class': 'markdown-alert markdown-alert-warning' } },
        { name: 'Danger', element: 'div', attributes: { 'class': 'markdown-alert markdown-alert-important' } },
        { name: 'Tip', element: 'div', attributes: { 'class': 'markdown-alert markdown-alert-tip' } }
    ];
