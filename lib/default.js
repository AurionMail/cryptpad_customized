...
Default.commonCSP = function (Env) {
    ...
    return [
        ...
        /*  this allows connections over secure or insecure websockets
            ...
            the ws://* directive
         */
        // We added the origin of the Core API to retrieve secret to connect.
        `connect-src 'self' blob: ${domain} ${sandbox} ${accounts_api} ${wsURL} https://api.AURION_DOMAIN_REPLACE_ME `,
